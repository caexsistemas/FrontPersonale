...
@Component({
  selector: 'app-massTyping',
  templateUrl: './massTyping.component.html',
  styleUrls: ['./massTyping.component.css']
})
export class MassTypingComponent implements OnInit {

  endpoint: string = "/massTyping";
   id: number = null;
   ...
   //Control Permiso
   component = "/callcenter/massTyping";
   //History
     ...
     this.WebApiService.getRequest(this.endpoint, {
       ...
       (data) => {
         ...
         if (data.success == true) {
           ...
           this.ListUsers = data.data["getUsers"];
               ...
               data => {
                   if (data.success) {
                    ...
                    //  this.handler.showSuccess("La carga se completó con éxito; ahora puedes descargar haciendo clic en el botón <b>Base</b> o al siguiente <b>Link</b> <a href='"+this.dowlExcel.url+"'>"+this.dowlExcel.name+"</a>");
                     this.handler.showSuccess("La carga se completó con éxito");
