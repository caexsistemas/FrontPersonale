...
export class ManagementDialog implements AfterContentChecked {
  ...
  optionSelect(datos) {
    for (let val in datos) {
      ...
      //Pension
      if (datos[val]["list_id"] == 11) {
        this.typePension.push(datos[val]);
      }
      //Cesantias
      if (datos[val]["list_id"] == 12) {
        this.typeCesantias.push(datos[val]);
      }
      //Caja Compensacion
      if (datos[val]["list_id"] == 8) {
        this.typeCajaComp.push(datos[val]);
      }
      //Nivel Academico
      if (datos[val]["list_id"] == 1) {
        this.nevAcademy.push(datos[val]);
      }
      //Tipo de contrato
      if (datos[val]["list_id"] == 5) {
        this.typeContr.push(datos[val]);
      }
      //Area
      if (datos[val]["list_id"] == 14) {
        this.typeArea.push(datos[val]);
      }
      //Posicion
      if (datos[val]["list_id"] == 16) {
        this.typeposition.push(datos[val]);
      }
      //Tipo Salario
      if (datos[val]["list_id"] == 81) {
        this.typeSalarynom.push(datos[val]);
      }
    }
  }
    ...
    this.WebApiService.getRequest(this.endpoint, {
      ...
      (data) => {
        if (data.success) {
          ...
          this.formUsuario
            .get("businessEmail")
            .setValue(this.usuario.businessEmail);
          this.formUsuario
            .get("idDocumentType")
            .setValue(this.usuario.idDocumentType);
          //Validar Data
          if (this.usuario.expeditionDate !== null) {
            this.formUsuario
              .get("expeditionDate")
              .setValue(
                this.usuario.expeditionDate.split("-").reverse().join("-")
              );
          } else {
          ...
          this.formUsuario
            .get("isColombian")
            .setValue(this.usuario.isColombian);
          this.formUsuario
            .get("idEthnicGroup")
            .setValue(this.usuario.idEthnicGroup);
          this.formUsuario
            .get("certificate")
            .setValue(this.usuario.certificate);
          this.formUsuario.get("idMarital").setValue(this.usuario.idMarital);
          this.formUsuario
            .get("nameContact")
            .setValue(this.usuario.nameContact);
          this.formUsuario
            .get("phoneEmergency")
            .setValue(this.usuario.phoneEmergency);
          this.formUsuario
            .get("businessEmail")
            .setValue(this.usuario.businessEmail);
          ...
          this.formUsuario
            .get("neighborhood")
            .setValue(this.usuario.neighborhood);
          this.formUsuario
            .get("displacementTime")
            .setValue(this.usuario.displacementTime);
          this.formUsuario.get("zone").setValue(this.usuario.zone);
          //Departamentexpedition
          this.formUsuario
            .get("Departamentexpedition")
            .setValue(this.usuario.idstateexpedition);
          this.onSelect(this.usuario.idstateexpedition);
          //DepartamentBirth
          this.formUsuario
            .get("DepartamentBirth")
            .setValue(this.usuario.idstatebirth);
          this.onSelectBirth(this.usuario.idstatebirth);
          //Departamentworking
          this.formUsuario
            .get("expeditionCity")
            .setValue(this.usuario.expeditionCity);
          ...
          this.formUmedical
            .get("treatment")
            .setValue(this.medicalinf.treatment);
          //foncep
          ...
          this.formFoncep
            .get("idSeverance")
            .setValue(this.foncepinf.idSeverance);
          this.formFoncep.get("idBenefit").setValue(this.foncepinf.idBenefit);
          this.formFoncep
            .get("coverageArl")
            .setValue(this.foncepinf.coverageArl);
          //Academy
          this.academyinf = data.data[3][0];
          this.formAcademy
            .get("idAcademicLevel")
            .setValue(this.academyinf.idAcademicLevel);
          this.formAcademy
            .get("isStudying")
            .setValue(this.academyinf.isStudying);
          this.formAcademy
            .get("notStudying")
            .setValue(this.academyinf.notStudying);
          this.formAcademy.get("typeStudy").setValue(this.academyinf.typeStudy);
          this.formAcademy
            .get("studyMotivation")
            .setValue(this.academyinf.studyMotivation);
          //working
          this.workininf = data.data[4][0];
          this.formWorking
            .get("idContract")
            .setValue(this.workininf.idContract);
          this.formWorking
            .get("idPosition")
            .setValue(this.workininf.idPosition);
          this.formWorking.get("idArea").setValue(this.workininf.idArea);
          this.formWorking
            .get("immediateBoss")
            .setValue(this.workininf.immediateBoss);
          this.formWorking
            .get("fechactusalary")
            .setValue(this.workininf.fechactusalary);
          this.formWorking
            .get("tipsalarywork")
            .setValue(this.workininf.tipsalarywork);

          //Departamentworking
          this.formWorking
            .get("Departamentworking")
            .setValue(this.workininf.stateidworkin);
          this.onSelectLabor(this.workininf.stateidworkin);
          this.formWorking.get("cityWork").setValue(this.workininf.cityWork);
          this.formWorking
            .get("vacantInformation")
            .setValue(this.workininf.vacantInformation);
          //Validar Data
          if (this.workininf.admissionDate != null) {
            this.formWorking
              .get("admissionDate")
              .setValue(
                this.workininf.admissionDate.split("-").reverse().join("-")
              );
          } else {
          ...
          this.formWorking
            .get("withdrawalDate")
            .setValue(this.workininf.withdrawalDate);
          if (this.workininf.withdrawalDate != null) {
            this.formWorking
              .get("withdrawalDate")
              .setValue(
                this.workininf.withdrawalDate.split("-").reverse().join("-")
              );
          } else {
          ...
          this.formWorking
            .get("bringResume")
            .setValue(this.workininf.bringResume);
          //Family
          ...
          this.formFamily
            ...
            .setValue(this.typefamilyinf.economicContribution);
          this.formFamily
            .get("economicDependence")
            .setValue(this.typefamilyinf.economicDependence);
          this.formFamily
            .get("peopleCoexist")
            .setValue(this.typefamilyinf.peopleCoexist);
          this.formFamily
            .get("familyIncome")
            .setValue(this.typefamilyinf.familyIncome);
          this.formFamily
            .get("incomeExpenses")
            .setValue(this.typefamilyinf.incomeExpenses);
          this.formFamily.get("typeHome").setValue(this.typefamilyinf.typeHome);
          this.formFamily
            .get("familyDisability")
            .setValue(this.typefamilyinf.familyDisability);
          this.formFamily
            .get("numberChildren")
            .setValue(this.typefamilyinf.numberChildren);
          this.formFamily
            .get("childrenDepends")
            .setValue(this.typefamilyinf.childrenDepends);
          //Salary
          ...
          this.formSalary
            .get("transportation")
            .setValue(this.typeSalaryinfo.transportation);
          //Children
          this.childrensinf = data.data[6];
          this.childrensinf.forEach(
            function (obj, index) {
