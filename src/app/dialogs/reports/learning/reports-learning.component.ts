...
@Component({
  selector: 'app-reports-learning',
  templateUrl: './reports-learning.component.html',
  styleUrls: ['./reports-learning.component.css']
})
export class ReportsLearningComponent implements OnInit {

  ndpoint: string = '/learning';
