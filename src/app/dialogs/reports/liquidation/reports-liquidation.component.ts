...
@Component({
  selector: 'app-reports-liquidation',
  templateUrl: './reports-liquidation.component.html',
  styleUrls: ['./reports-liquidation.component.css']
})
export class ReportsLiquidationComponent implements OnInit {
