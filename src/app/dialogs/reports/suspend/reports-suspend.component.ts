...
@Component({
  selector: 'app-reports-suspend',
  templateUrl: './reports-suspend.component.html',
  styleUrls: ['./reports-suspend.component.css']
})
export class ReportsSuspendComponent implements OnInit {

  
  ndpoint: string = '/suspend';
