import {
  ...
  @Component({
    selector: 'app-report',
    templateUrl: './reports-pqrCallCenter.component.html',
    styleUrls: ['./reports-pqrCallCenter.component.css']
  })

  export class ReportsPqrCallCenterComponent implements OnInit {
