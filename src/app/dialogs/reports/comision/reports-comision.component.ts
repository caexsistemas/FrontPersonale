import {
  ...
  @Component({
    selector: 'app-report',
    templateUrl: './reports-comision.component.html',
    styleUrls: ['./reports-comision.component.css']
  })

  export class ReportsComisionComponent implements OnInit {

    
    ndpoint: string = '/commisions';
